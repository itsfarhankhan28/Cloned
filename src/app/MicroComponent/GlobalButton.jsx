...
const GlobalButton = () => {
  return (
    <button className="md:px-5 md:py-3 px-3 py-1 bg-orange-400 rounded-lg font-[600] text-white md:text-xl flex justify-center items-center gap-1 cursor-pointer shadow-[0px_7px_12px_-3px_rgba(8,8,8,0.66)] text-[14px]">Get Started Now 
