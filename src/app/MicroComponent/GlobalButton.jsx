...
const GlobalButton = () => {
  return (
    <button className="px-5 py-3 bg-orange-400 rounded-lg font-bold text-white md:text-xl flex gap-1 cursor-pointer shadow-[0px_7px_12px_-3px_rgba(8,8,8,0.66)] text-[14px]">Get Started Now 
        <span>
