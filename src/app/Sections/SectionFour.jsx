    ...
    <div className="text-gray-600 body-font">
        <div className="py-16 mx-auto flex flex-col">
            ...
            <div className="flex flex-col sm:flex-row items-center bg-[#ffecd4] rounded-3xl shadow-[0px_6px_7px_2px_rgba(166,166,166,0.97)]">
                ...
                <div>
                    <h1 className='text-[#ff7622] text-[20px]'>— BENEFITS OF CUSTOMERS</h1>
                </div>
                <div>
                    <p className='text-[28px] text-[#464646] font-[500]'>Access the best local offers, discover hidden gems in your neighborhood, and support the businesses that make your community unique.</p>
                </div>
